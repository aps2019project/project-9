...
public class MainMenu {
    ...
    public void start(Stage stage) {
        try {
            ...
            Font mainMenuFont = Font.loadFont(new FileInputStream(new File("Font/ALGER.TTF")), 60);
    ...
    void setButtons(Group root) {
        try {
            Font collectionFont = Font.loadFont(new FileInputStream(new File("Font/ALGER.TTF")), 25);
            ...
            Font shopFont = Font.loadFont(new FileInputStream(new File("Font/ALGER.TTF")), 30);
            ...
            Font battleFont = Font.loadFont(new FileInputStream(new File("Font/ALGER.TTF")), 35);
            ...
            Font logOutFont = Font.loadFont(new FileInputStream(new File("Font/ALGER.TTF")), 26);
